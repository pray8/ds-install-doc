...
@Component({
    ...
    templateUrl: './ins-how-to.component.html',
    styleUrls: ['./ins-how-to.component.scss']
})
export class InsHowToComponent implements OnInit {
    ...
    loadMarkdownFile() {
        const markdownPath = 'assets/docs/ins-how-to.md';
