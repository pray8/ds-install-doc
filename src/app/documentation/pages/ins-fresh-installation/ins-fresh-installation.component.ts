...
@Component({
    selector: 'app-ins-fresh-installation',
    templateUrl: './ins-fresh-installation.component.html',
    styleUrls: ['./ins-fresh-installation.component.scss']
})
export class InsFreshInstallationComponent implements OnInit {
    ...
    loadMarkdownFile() {
        const markdownPath = 'assets/docs/installation-guide-fresh-install.md';
