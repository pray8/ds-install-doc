...
@Component({
    selector: 'app-opscenter-agents',
    templateUrl: './opscenter-agents.component.html',
    styleUrls: ['./opscenter-agents.component.scss']
})
export class OpscenterAgentsComponent implements OnInit {
    ...
    loadMarkdownFile() {
        const markdownPath = '/app/assets/docs/opscenter-agents.md';
